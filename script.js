...
{id:'1-15', col:16, icon:'▧', name:'해금 그룹 I', pts:2, group:'unlock-group', unlockable:true, requiresAny:['3-12','3-13'], lineBottom:true},
{id:'1-16', col:15, icon:'◉', name:'해금 독립 I', pts:2, unlockable:true, requiresAny:['3-12','3-13']},
...
{id:'2-15', col:16, icon:'▧', name:'해금 그룹 II', pts:2, group:'unlock-group', unlockable:true, requiresAny:['3-12','3-13'], lineTop:true},
{id:'2-16', col:15, icon:'◉', name:'해금 독립 II', pts:2, unlockable:true, requiresAny:['3-12','3-13']},
...
function isDisabled(card){
  ...
  if(card.requiresAny){
    return !card.requiresAny.some(id=>
      selected.has(id)
    );
  }
...
function removeDependentCards(){
  ...
  getAllCards().forEach(card=>{
    ...
    const unlocked=card.requiresAny.some(id=>
      selected.has(id)
    );
