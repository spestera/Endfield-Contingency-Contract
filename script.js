  ...
  if(selected.size === 0){
    list.innerHTML = `
      <div class="panel-empty">
        ...
        ==========[도움말]==========<br>
        ※ 이 사이트는 PC를 기준으로 제작되었습니다.<br>
        가급적 PC로 이용하길 추천드립니다.<br><br>
        
        ※ 비율이 안맞는 경우<br> 
        Ctrl + 마우스 휠로 비율을 조절해주세요.<br><br>

        ※ 위기협약 시작 날짜는 6월 19일 입니다.<br><br>
        
        ※ 실제 위기 협약에서 모든 지표가 열리는 건<br> 
        6월 26일 이후<br>
        10점 이상 클리어 1회가 필요한것으로 추측 됩니다.<br><br>
        
        ※ 훈장 및 보상 커트라인은 20점이라 합니다. <br>
        최소 목표로 삼길 추천합니다.<br><br>
  
        ※ 지표의 종류는 3가지이며,<br>
        주로 다음과 같은 특징을 가집니다.<br>
  
        - 팀 : 오퍼레이터 관련 제약<br>
        - 조작 : 적 관련 제약<br>
        - 환경 : 전장상황 또는 전투 상호작용 관련 제약<br><br>
  
        ※ 왼쪽 하단의 [선택 결과] 버튼을 클릭해서 Win + Shift + S 또는 <br>
        화면 캡처를 활용하여 공유가 가능합니다.<br><br>

        ※ 실제 위기협약 출시 후 지표 내용이 달라질 수 있습니다.<br>
